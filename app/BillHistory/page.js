  ...
  return (
    <div className="container px-1 lg:px-4">
      ...
      {bills.length>0?bills.map((item)=>{
        return <div key={item._id} className="flex mb-2 justify-between items-center cursor-pointer hover:bg-slate-200 bg-slate-300 p-2 rounded text-lg font-medium border border-neutral-600">
